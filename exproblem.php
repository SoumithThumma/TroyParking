                ...
                <div class="card hovercard" style="padding-bottom:20px;">
                    ...
                    <div class="bottom">
                        ...
                        <div class="desc" style="margin-top:10px; margin-bottom:30px; text-align:left;">
                            Sorry for the inconvenience. Please leave a reason for your problem, and we'll look into the issue. You will be given temporary points to use within the next fifteen minutes. Enjoy your day. 
                        </div>
...
<button onclick="location.href = \'transaction.php?cancel=true\';" class="btn btn-lg btn-primary btn-block btn-problem" style="margin-top:5px;">Cancel</button>
